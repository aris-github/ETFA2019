 ...
 * </p>
 * <ul>
 *   <li>{@link CAEX215.impl.DescriptionTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link CAEX215.impl.DescriptionTypeImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionTypeImpl extends MinimalEObjectImpl.Container implements DescriptionType {
	...
	protected EClass eStaticClass() {
		return CAEX215Package.Literals.DESCRIPTION_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEX215Package.DESCRIPTION_TYPE__VALUE, oldValue, value));
	}
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		changeModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEX215Package.DESCRIPTION_TYPE__CHANGE_MODE, oldChangeMode, changeMode, !oldChangeModeESet));
	}
	...
	public void unsetChangeMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CAEX215Package.DESCRIPTION_TYPE__CHANGE_MODE, oldChangeMode, CHANGE_MODE_EDEFAULT, oldChangeModeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CAEX215Package.DESCRIPTION_TYPE__VALUE:
				return getValue();
			case CAEX215Package.DESCRIPTION_TYPE__CHANGE_MODE:
