...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Interface Name Mapping Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link CAEX215.impl.InterfaceNameMappingTypeImpl#getRoleInterfaceName <em>Role Interface Name</em>}</li>
 *   <li>{@link CAEX215.impl.InterfaceNameMappingTypeImpl#getSystemUnitInterfaceName <em>System Unit Interface Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceNameMappingTypeImpl extends CAEXBasicObjectImpl implements InterfaceNameMappingType {
	/**
	 ...
	 * @generated
	 */
	protected InterfaceNameMappingTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CAEX215Package.Literals.INTERFACE_NAME_MAPPING_TYPE;
	}
	...
	public void setRoleInterfaceName(String newRoleInterfaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEX215Package.INTERFACE_NAME_MAPPING_TYPE__ROLE_INTERFACE_NAME, oldRoleInterfaceName, roleInterfaceName));
	}
	...
	public void setSystemUnitInterfaceName(String newSystemUnitInterfaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CAEX215Package.INTERFACE_NAME_MAPPING_TYPE__SYSTEM_UNIT_INTERFACE_NAME, oldSystemUnitInterfaceName, systemUnitInterfaceName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CAEX215Package.INTERFACE_NAME_MAPPING_TYPE__ROLE_INTERFACE_NAME:
				return getRoleInterfaceName();
			case CAEX215Package.INTERFACE_NAME_MAPPING_TYPE__SYSTEM_UNIT_INTERFACE_NAME:
